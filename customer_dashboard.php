...
<!-- Content start -->
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="row">
        <div class="col-sm-3">
        <img src="user-png-icon-male-user-icon-512.png" width="100%" height="100%">
         </div>
        <div class="col-sm-9">
...
<div class="col-lg-6">
 ...
 <label for="Contact_no">Contact no:</label>
   ...
   <input type="text" class="form-control" id="contact_1"  name="contact_no" value="<?php echo $contact;?>" placeholder="contact no" readonly>
 </div>
</div>
 ...
 <div class="col-lg-12">
   ...
   <textarea name="add" class="form-control" readonly placeholder="Adress" id="address_1"><?php echo $add;?></textarea>
 </div>
 </div>
 ...
 <div class="col-lg-9">
   ...
   <input type="text" class="form-control" name="email" value="<?php echo $email;?>" placeholder="Email" id="email_1" readonly>
 </div>
 <div class="col-lg-3">
 ...
 <button class="btn btn-danger"><a href="" style="color: #fff; text-decoration: none;">Reset</a></button>
 </div>
</div>
</form>
    </div>
        ...
        <table class="table  table-bordered" style="margin-top:10px;" style="width:100%;" align="center">
          ...
          ?>
              <tr>
                ...
                <td><a href="view_transaction_customer.php?RID=<?php echo $row2["acc_no"] ?>"><span class="fas fa-low-vision"> View transactions</span></a></td>
              </tr>
              <?php $get=$row2["acc_no"];;}} ?>
              </tbody>
            </table>
      ...
      <div class="row">
        ...
        <table class="table  table-bordered" style="margin-top:10px;" style="width:100%;" align="center">
          ...
          ?>
            ...
            <td align="center"><a href="loan_summary_customer.php?RID=<?php echo $row3['lid'];?>" style="text-decoration: none;"><span class="fas fa-low-vision"></span >View </a> </td>
          </tr>
              <?php }}?>
                <tr>
              <tr>
