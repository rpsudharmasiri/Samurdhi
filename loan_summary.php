        ...
        <div class="container-fluid"><!-- Page Heading -->
            <div class="row" id="main" style="margin: 0;">
                <div class="col-sm-12 col-md-12 well" id="content" style="background-color: #ffff; border: 1px solid #f9f6f6;">
                    ...
                    <a class="btn btn-default" href="list_of_loans.php" style="float:right;margin-left:2px;"><i class="glyphicon glyphicon-chevron-left"> Back</i></a>
                    <a class="btn btn-default" href="list_of_loans.php" style="float:right;"><i class="glyphicon glyphicon-euro"> payment</i></a>
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          <td><?php echo $row["month_payment"] ?></td>
            ...
            <a class="btn btn-warning btn-labeled" role="button" onclick="return confirm('would you like to make payment?')"  href="loan_payment.php?RID=<?php echo $row["id"] ?>"><?php echo $row["payment_status"] ?></a>
                <?php } ?>
            </td>
          </tr>
